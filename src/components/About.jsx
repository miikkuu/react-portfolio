...
export const About = () => {
  return (
    <div className=" pointer-events-none border-b border-neutral-900 pb-4 -mt-5">
      ...
      <div className=" caret-transparent flex flex-wrap">
        <motion.div
        ...
        >
          <div className="pointer-events-none flex rounded-2xl items-center justify-center overflow-hidden h-[400px] w-[450px] object-fill ">
            <img
